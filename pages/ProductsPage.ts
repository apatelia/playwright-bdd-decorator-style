...
export @Fixture<typeof test>(`productsPage`) class ProductsPage {
  readonly page: Page;
  ...
  @Then('the user should be able to remove {string} from the cart, using the `Remove` button')
  ...
  async userIsTakenToProductsPage () {
